# Operator Quickstart — Motion picture, video and television programme post-production activities

Shortest path from clone to a verified local dry-run for **ISIC 5912** (`cloud-itonami-isic-5912`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-5912.git
cd cloud-itonami-isic-5912
```
...
- Blueprint governor key: `postprod-governor`
- Likely source path: `postprodops.governor.cljc`
