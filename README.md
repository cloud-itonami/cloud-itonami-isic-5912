...
- `test/postprodops/governor_test.cljk` — unit tests of governor hard checks and scope exclusion
- `test/postprodops/advisor_test.cljk` — advisor proposal shape and consistency
- `test/postprodops/phase_test.cljk` — rollout phase logic
- `test/postprodops/governor_contract_test.cljk` — full graph integration, audit trail
- `test/postprodops/store_contract_test.cljk` — Store protocol and MemStore implementation
